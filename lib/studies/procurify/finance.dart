...
import 'package:gallery/studies/procurify/charts/line_chart.dart';
import 'package:gallery/studies/procurify/charts/pie_chart.dart';
import 'package:gallery/studies/procurify/charts/vertical_fraction_bar.dart';
import 'package:gallery/studies/procurify/colors.dart';
import 'package:gallery/studies/procurify/data.dart';
import 'package:gallery/studies/procurify/formatters.dart';
      ...
      return Column(
        children: [
          ...
          Container(
            ...
            color: ProcurifyColors.inputBackground,
          ),
          Container(
            constraints: BoxConstraints(maxWidth: maxWidth),
            color: ProcurifyColors.cardBackground,
            child: Column(
        ...
        child: Column(
          children: [
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: textTheme.bodyText2
                                  .copyWith(color: ProcurifyColors.gray60),
                            ),
                          ],
                        ),
                        Text(
            ...
            const Divider(
              ...
              indent: 16,
              endIndent: 16,
              color: ProcurifyColors.dividerColor,
            ),
          ],
        ),
      ),
...
FinancialEntityCategoryView buildFinancialEntityFromAccountData(
  ...
  return FinancialEntityCategoryView(
    ...
    indicatorColor: ProcurifyColors.accountColor(accountDataIndex),
    indicatorFraction: 1,
    amount: amount,
  );
}
...
FinancialEntityCategoryView buildFinancialEntityFromBillData(
  ...
  return FinancialEntityCategoryView(
    ...
    indicatorColor: ProcurifyColors.billColor(billDataIndex),
    indicatorFraction: 1,
    amount: amount,
  );
}
  ...
  return FinancialEntityCategoryView(
    suffix: Text(
      ...
      style: Theme.of(context)
          .textTheme
          .bodyText2
          .copyWith(color: ProcurifyColors.gray60, fontSize: 10),
    ),
    title: model.name,
    ...
    indicatorColor: ProcurifyColors.budgetColor(budgetDataIndex),
...
class _EventDate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      ...
      style: textTheme.bodyText2.copyWith(color: ProcurifyColors.gray60),
    );
  }
}
