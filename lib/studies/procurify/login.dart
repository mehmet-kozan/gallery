...
class _MainView extends StatelessWidget {
  ...
  void _login(BuildContext context) {
    Navigator.of(context).pushNamed(ProcurifyApp.homeRoute);
  }
        ...
        child: Row(
          children: [
            const Icon(Icons.check_circle_outline,
                color: ProcurifyColors.buttonColor),
...
class _BorderButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlineButton(
      borderSide: const BorderSide(color: ProcurifyColors.buttonColor),
      color: ProcurifyColors.buttonColor,
      highlightedBorderColor: ProcurifyColors.buttonColor,
      focusColor: ProcurifyColors.buttonColor.withOpacity(0.8),
